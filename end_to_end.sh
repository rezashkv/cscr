...
# ------------------ build umr ----------------------- #
python scripts/build_umr.py --work_dir baselines/umr/umr_artifacts_embedllm --knn_index experts/indices/embedllm/faiss_index.ivf --knn_labels experts/indices/embedllm/faiss_index.ivf.labels.json --val_prompts data/probes_embedllm-192.json --encoder_ckpt checkpoints/embedllm/contrastive_encoder_expert_aware_cost-spectrum-info-nce/checkpoint-6/ --lambda_ 0.1 --bandit_beta 0.000001 --k 20 --dataset embedllm --cost_type "n_params"
